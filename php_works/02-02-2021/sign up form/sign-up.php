<?php
  ...
  if(isset($_REQUEST['add'])){  
        ...
        if(!empty($fname) && !empty($lname) && !empty($dob) && !empty($gender) && !empty($country) && !empty($email) && !empty($pass)){
          ...
          $query = "insert into register(firstname,lastname,dob,gender,country,email,upass)value('$fname','$lname','$dob','$gender','$country','$email','$pass')";

          if(mysqli_query($conn,$query)){
            echo '<strong>User Register Successfully</strong>';
          }
          else{
            mysqli_error($conn);
            ...
            <div class="card text-left">
              ...
              <h2 class="text-center">Sign Up</h2>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fname" id="fname" aria-describedby="emailHelpId" 
                    pattern="[a-z]+" title="please Enter Name in Proper Format"
                    placeholder="Enter Username">
                    <small id="emailHelpId" class="form-text text-muted">Enter Name</small>
                  </div>
                  <div class="form-group">
                    <label for="">Last Name</label>
                    <input type="text" class="form-control" name="lname" id="lname" aria-describedby="emailHelpId" 
                    pattern="[a-z]+" title="please Enter  lastName in Proper Format"
                    placeholder="Enter Username">
                    <small id="emailHelpId" class="form-text text-muted">Enter Name</small>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="uemail" id="uemail" aria-describedby="emailHelpId" 
                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Enter Email In Correct Format"
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="ucpass" id="ucpass" aria-describedby="emailHelpId" 
                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters"
                    placeholder="Enter Password">
